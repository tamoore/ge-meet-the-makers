        ...
        return (
			<footer>
				...
				<div className="page-nav border-bottom">
					<a className="page-nav-previous" href={"#/content/"+makerData.slug+"/"+prevContent.slug}>Previous</a>
					<div className="page-nav-counter">{contentIndex+1} of {contentCount}</div>
					<a className="page-nav-next" href={"#/content/"+makerData.slug+"/"+nextContent.slug}>Next</a>
				</div>
