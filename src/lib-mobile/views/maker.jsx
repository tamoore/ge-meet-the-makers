...
export class FooterTimelineLinkComponent extends React.Component {
    ...
    render(){
        return (
			<a className="link-wide" onClick={this.handleClick} href="#/">Explore their timeline</a>
        )
    }
}
    ...
    render(){
        ...
        return (
			<footer>
				...
				<a className="link-wide" href="#/makers">Back to Meet the makers</a>
				<a className="link-wide" href="#/"><i className="arrow-back"></i>Back to timeline</a>
			</footer>
        )
    }
}
